      ...
      {didSelect ? (
        ...
        <>
          <main className="flex min-h-screen items-center justify-center  md:p-8 ">
            <div className="w-full max-w-lg md:max-w-3xl rounded-xl bg-gray-100 shadow-xl   p-6 md:p-8">
              {/* Header */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                {selectedList?.map((merchant: MerchantType) => (
                  <div
                    className="bg-white rounded-2xl  transition-all duration-300 hover:scale-[1.02] hover:shadow-xl cursor-pointer ring-2 ring-transparent "
                    key={merchant.id}
 ...
 const addLogs = async (
  ...
  return (
    <div className="font-sans flex flex-col items-center justify-center min-h-screen  p-4">
      <div className="flex flex-col w-full max-w-lg bg-gray-100 rounded-3xl shadow-2xl p-6 md:p-8">
        {/* Header */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-800 tracking-tight">
            Selected Reward
